...
class LeftNavbar extends Component {
  ...
  render() {
    ...
    const { position, isDragging, isHovered } = this.state;
    const navbarClass = `left-navbar ${!isHovered && !isDragging ? 'auto-hide' : ''} ${isDragging ? 'dragging' : ''}`;
